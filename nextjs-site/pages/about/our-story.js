        ...
        <div className="container" style={{ maxWidth: '920px' }}>
          ...
          <div className="vision-mission-grid">
            <div className="vision-card">
              ...
              <h2 style={{ fontFamily: 'var(--font-heading)', fontSize: '1.5rem', fontWeight: 700, marginBottom: '1rem', color: '#FFFFFF' }}>
                Our Vision
              </h2>
            ...
            <div className="mission-card">
              ...
              <h2 style={{ fontFamily: 'var(--font-heading)', fontSize: '1.5rem', fontWeight: 700, marginBottom: '1rem', color: 'var(--color-heading)' }}>
                Our Mission
              </h2>
          ...
          <div className="values-grid">
            {values.map((v, idx) => (
              ...
              >
                ...
                <h3 style={{ fontFamily: 'var(--font-heading)', fontSize: '1.15rem', fontWeight: 700, color: 'var(--color-heading)', marginBottom: '0.5rem' }}>
                  {v.title}
                </h3>
