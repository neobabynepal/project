...
export default function UtilityBar({ settings }) {
  ...
  const hasContactInfo = Boolean(phone || address || email);
  const hasSocials = Boolean(instagram || tiktok || facebook || linkedin || youtube);
        ...
        <div className="utility-info">
          {phone && (
            <div className="utility-item">
              ...
              <span>Telephone: <strong>{phone}</strong></span>
            </div>
          )}
          {address && (
            <div className="utility-item">
              ...
              <span>Headquarters: <strong>{address}</strong></span>
            </div>
          )}
          {email && (
            <div className="utility-item">
